...
})({"ivyTu":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "5f55c0658ab29772";
...
},{}],"kdPx3":[function(require,module,exports) {
/* The main entry file for the styleguide page bundle */ var _styleguideCss = require("./styles/styleguide.css");
var _componentConfig = require("./scripts/styleguide/component-config");
var _icon = require("./scripts/styleguide/icon");
var _backdrop = require("./scripts/styleguide/backdrop");
var _colors = require("./scripts/styleguide/colors");
var _headerProfile = require("./scripts/styleguide/header-profile");

},{"./styles/styleguide.css":"7VIgE","./scripts/styleguide/component-config":"cYwm8","./scripts/styleguide/icon":"lwJpn","./scripts/styleguide/backdrop":"lq1ZR","./scripts/styleguide/colors":"8AyaJ","./scripts/styleguide/header-profile":"kENxO"}],"7VIgE":[function() {},{}],"cYwm8":[function(require,module,exports) {
...
},{}],"lwJpn":[function(require,module,exports) {
const iconComponentsWrapper = document.querySelector('[data-styleguide-component="Icon"]');
if (iconComponentsWrapper) iconComponentsWrapper.querySelectorAll("svg").forEach((svgElement)=>{
...
},{}],"lq1ZR":[function(require,module,exports) {
...
},{}],"8AyaJ":[function(require,module,exports) {
const colorComponentsWrapper = document.querySelector('[data-styleguide-component="colors"]');
if (colorComponentsWrapper) colorComponentsWrapper.querySelectorAll("[data-color]").forEach((colorElement)=>{
...
},{}],"kENxO":[function(require,module,exports) {
...
},{}]},["ivyTu","kdPx3"], "kdPx3", "parcelRequire2e46")
